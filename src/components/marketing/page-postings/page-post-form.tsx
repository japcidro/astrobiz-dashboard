...
export function PagePostForm() {
  ...
  const canPost = pageId && (message.trim() || mediaFile) && !posting;
  ...
  async function handlePost() {
    ...
    if (!message.trim() && !mediaFile) {
      toast.error("Maglagay ng message, larawan, o video.");
      return;
    }
    ...
    try {
      ...
      if (mediaFile) {
        ...
        if (trimmed) fbForm.append(isVideo ? "description" : "caption", trimmed);
        if (schedule.ts) {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <p className="text-sm text-gray-400 mb-6">
        Mag-publish o mag-schedule ng organic post (text, larawan, o video) sa
        iyong Facebook Page.
      </p>
          ...
          {scheduleEnabled && (
            <div className="mt-3">
              ...
              <p className="mt-1.5 text-xs text-gray-500">
                Kailangan hindi bababa sa 10 minuto mula ngayon, at nasa loob ng
                6 na buwan.
              </p>
            </div>
          )}
