    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-950">
      <div className="w-full max-w-md p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Astrobiz</h1>
          <p className="text-gray-400">Operations Dashboard</p>
        </div>
        ...
        <p className="mt-6 text-center text-gray-500 text-xs">
          Only authorized employees can access this dashboard.
        </p>

        <div className="mt-4 flex gap-4 justify-center text-gray-600 text-xs">
          ...
          <a href="/data-deletion" className="hover:text-gray-400">Data Deletion</a>
        </div>
      </div>
    </div>
  );
